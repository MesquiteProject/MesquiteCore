...
*/
package mesquite.molec.FindInternalGap;
/*~~  */
...
/* ======================================================================== */
public class FindInternalGap extends FindSequenceCriterionG {
	/*.................................................................................................................*/
		...
		for (int it = firstTaxon; it< numTaxa; it++){
			for (int ic = firstChar; ic< numChars; ic++) {
				if (data.isInternalInapplicable(ic, it)) {
					...
					int next=data.nextApplicable(it, ic, true);
					length.setValue(next-ic);
					return true;
				}
			}
		}
	...
	public String getName() {
		return "Find Internal Gaps";
	}
	/*.................................................................................................................*/
	/** returns an explanation of what the module does.*/
	public String getExplanation() {
		return "Finds the next occurrence of an internal gap in a matrix of molecular data." ;
	}
