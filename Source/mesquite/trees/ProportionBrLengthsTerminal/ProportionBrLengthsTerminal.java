...
public class ProportionBrLengthsTerminal extends NumberForTree {
	...
	public void surveyBranches(Tree tree, int node, MesquiteDouble termBL, MesquiteDouble totalBL) {
		...
		if (tree.getRoot() != node && MesquiteDouble.isCombinable(length)){
			...
			if (!totalBL.isCombinable())
				totalBL.setValue(length);
			else
				totalBL.add(length);
			if (tree.nodeIsTerminal(node)){
				if (!termBL.isCombinable())
					termBL.setValue(length);
				else
					termBL.add(length);
			}
		...
		for (int d = tree.firstDaughterOfNode(node); tree.nodeExists(d); d = tree.nextSisterOfNode(d))
			surveyBranches(tree, d, termBL, totalBL);
	...
	public void calculateNumber(Tree tree, MesquiteNumber result, MesquiteString resultString) {
		...
		MesquiteDouble termBL = new MesquiteDouble();
		MesquiteDouble totalBL = new MesquiteDouble();
		surveyBranches(tree, tree.getRoot(), termBL, totalBL);
		if (termBL.isCombinable() && totalBL.isCombinable() && totalBL.getValue() != 0){
	...
	public String getName() {
		return "Proportion Terminal Branch Lengths";
	}
	public String getNameForMenuItem() {
		return "Prop. Terminal Branch Lengths";
	}
	/*.................................................................................................................*/
	/*.................................................................................................................*/
	/*.................................................................................................................*/
	...
	public String getExplanation() {
		return "Gets the proportion of branch length in a tree that is on terminal branches." ;
	}
