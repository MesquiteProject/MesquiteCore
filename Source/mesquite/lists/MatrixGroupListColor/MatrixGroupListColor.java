...
*/
package mesquite.lists.MatrixGroupListColor;
...
/* ======================================================================== */
public class MatrixGroupListColor extends MatrixGroupListAssistant  {
	//"@MATRIXGROUP
	...
	public String getName() {
		return "Matrix Group Color in List";
	}
	public String getExplanation() {
		return "Shows color assigned to matrix group." ;
	}
	...
	/*.................................................................................................................*/
	MatricesGroup getMatrixGroup(int ic){
		...
		if (groups!=null) {
			if (ic>=0 && ic<groups.size())
				return(MatricesGroup)groups.elementAt(ic);
		}
		return null;
	}
	...
	public Color getBackgroundColorOfCell(int ic, boolean selected){
		...
		MatricesGroup tg = getMatrixGroup(ic);
		if (tg!=null){
			return tg.getColor();
				...
				if (groups!=null  && table != null) {
					...
					for (int i = 0; i< groups.size(); i++){
						if (groups.getSelected(i) || table.isRowSelected(i)){
							MatricesGroup cg = getMatrixGroup(i);
							if (cg!=null){
	...
	public void specifyColor (int ic) {
		MatricesGroup cg = getMatrixGroup(ic);
		if (cg!=null){
			Color oldColor = null;
			if (chooseColor(oldColor)){
				cg.setColor(newColor);
