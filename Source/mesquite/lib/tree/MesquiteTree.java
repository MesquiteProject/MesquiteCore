...
and the tree has been rerooted. Properties that belong to nodes implicitly have an "up" polarity, and hence are sensitive to rerooting.*/
	...
	public CharacterData findLinkedMatrix(MesquiteProject project){
		...
		if (obj != null)
			d = project.getCharacterMatrixByReference(null, taxa, null, ((MesquiteString)obj).getValue());
		String treeName = getName();
		if (d == null)
			d = project.getCharacterMatrixByReference(null, taxa, null, treeName);
		if (d == null)
			d = project.getCharacterMatrixByReference(null, taxa, null, StringUtil.getAllButLastItem(treeName, "."));
		if (d == null)
			d = project.getCharacterMatrixByReference(null,taxa, null, StringUtil.getAllButLastItem(treeName, "#"));
