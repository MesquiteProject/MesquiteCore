...
public class MesquiteProject extends Attachable implements Listable, MesquiteListener, Commandable, HNode, HTMLDescribable {
	...
	/*.................................................................................................................*/
	//TODO: ฅฅฅ have general get number of elements, passing project, or file; counts
	...
	/*---------===---------===---------===---------===---------===---------===-------------------*/
	/** returns number of data sets in file*/
	public int  getNumberCharMatricesVisible() { //รรร
	...
	public int  getNumberCharMatrices(Taxa taxa) { //รรรรร
	...
	/*---------===---------===---------===---------===---------===---------===-------------------*/
	/** returns number of data sets belonging to given taxa*/
	public int  getNumberCharMatricesVisible(Taxa taxa) { //รรรรร
	...
	public int  getNumberCharMatricesVisible(Object dataClass) {  //รรรรร
	...
	/*---------===---------===---------===---------===---------===---------===-------------------*/
	/** returns number of data sets of a given data class (CharacterState subclass is passed)*/
	public int  getNumberCharMatrices(Object dataClass) {  //รรรรร
	...
	public int  getNumberCharMatricesVisible(Taxa taxa, Object dataClass) {  //รรรรร
	...
	public mesquite.lib.characters.CharacterData getCharacterMatrixVisible(Taxa taxa, int j, Object dataClass) { //รรรร
		return getCharacterMatrix(null, taxa, dataClass, j, true);
	}
	/*---------===---------===---------===---------===---------===---------===-------------------*/
	/** returns number of data sets belonging to a given file*/
	public int  getNumberCharMatrices(MesquiteFile f) { //รรรรร
		return getNumberCharMatrices(f, null, null, false);
	}
	/*......................*/
	/** returns the jth of data sets belonging to a given file*/
	public mesquite.lib.characters.CharacterData getCharacterMatrix(MesquiteFile f, int j) {  //รรรรร
	...
	/*......................*/
	/** returns the jth of data sets belonging to a given file*/
	public mesquite.lib.characters.CharacterData getCharacterMatrixVisible(MesquiteFile f, Taxa taxa, Object dataClass, int j) {  //รรรร not used yet
		return getCharacterMatrix(f, taxa, dataClass, j, true);
	}
	/*......................*/
	/** returns the jth of data sets belonging to a given file*/
	private mesquite.lib.characters.CharacterData getCharacterMatrix(MesquiteFile f, Taxa taxa, Object dataClass, int j) {  //รรรร
