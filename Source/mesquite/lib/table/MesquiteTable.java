...
etc. is left to the superclasses.<p>
...
of cells (the scrollable matrix), and the two scroll bars for the matrix.<p>
...
//	public static final int GRABBERS = 8;
	...
	/*...............................................................................................................*/
	/** Draws the shaded box that houses row or column numbers in a table.  
	Can also be used to just draw a shaded box, even if no row or column numbers are to be drawn. */
...
//	}
	...
	public void blankColumn(int column){
		if (!columnLegal(column))
			return;
		for (int r = firstRowVisible; r<getNumRows(); r++) //TODO: this and similar places (e.g. redrawMatrix) need to use getNumRowsVisible instead
...
//public MesquiteTimer rCellTimer = new MesquiteTimer();
	...
	/*...............................................................................................................*/
	/** Draws text into the corner cell.  Passed is the graphics context, and the 
	rectangle framing the cell.
	Must be overridden in subclasses to fill in corner cell appropriately.*/
	public  void drawCornerCell(Graphics g, int x, int y,  int w, int h){
		cornerCell.redrawName(g);
	}
	/*...............................................................................................................*/
	/** Draws cell of matrix of given column and row.
	Must be overridden in subclasses to fill in matrix cell appropriately.*/
	...
	/*...............................................................................................................*/
	/** Sets the Associable whose parts are tied to the columns (e.g., a CharacterData, whose characters are tied to columns)
	This is used to ensure that the Associable's selected parts are kept synchronous with the selection in this table.*/
	...
	/*...............................................................................................................*/
	/** Sets the Associable whose parts are tied to the row (e.g., a Taxa, whose taxa are tied to rows)
	This is used to ensure that the Associable's selected parts are kept synchronous with the selection in this table.*/
	...
	/*...............................................................................................................*/
	/** returns the boundaries of the next single block of cells selected within one row, starting from upper left, 
	and going through each row before going to next row.  If rows and columns passed in as MesquiteInteger are unassigned, 
	then this finds the first case.  Subsequent calls, if passed the same MesquiteIntegers retaining previously returned values, will find next block.*/
