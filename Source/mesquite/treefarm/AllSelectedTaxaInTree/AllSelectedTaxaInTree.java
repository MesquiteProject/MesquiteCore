...
*/
package mesquite.treefarm.AllSelectedTaxaInTree;
...
public class AllSelectedTaxaInTree extends BooleanForTree implements MesquiteListener {
	...
	public void calculateBoolean(Tree tree, MesquiteBoolean result, MesquiteString resultString) {
		...
		boolean bt = tree.taxaInTree(taxa.getSelectedBits());
		result.setValue(bt);
		if (resultString!=null)
			if (bt)
				resultString.setValue("All present");
			else
				resultString.setValue("Some absent");
	}
	/*.................................................................................................................*/
	...
	/*.................................................................................................................*/
		...
		return "Selected Taxa are All in Tree";
   	 }
	/*.................................................................................................................*/
	...
	/*.................................................................................................................*/
 	...
 	public String getExplanation() {
 		return "Determines if the selected taxa are all in a tree." ;
   	 }
