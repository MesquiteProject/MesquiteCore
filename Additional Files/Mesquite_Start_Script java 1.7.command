dir=`dirname "$0"`
/Library/Java/JavaVirtualMachines/jdk1.7.0_45.jdk/Contents/Home/bin/java -d64 -Xmx4000M -Xss2m -Djava.library.path=lib -Djri.ignore.ule="yes" -cp "$dir" mesquite.Mesquite
